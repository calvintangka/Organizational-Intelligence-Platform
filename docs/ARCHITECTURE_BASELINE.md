...
Durable memory includes organization-scoped tickets, knowledge items, candidates, validation records, trust evidence, memory-change records, prepared reflections, and emerging patterns. Memory changes are reviewable and auditable; retrieval compatibility is separate from trust and promotion decisions.
