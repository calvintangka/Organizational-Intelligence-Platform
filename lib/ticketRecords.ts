...
export function createTicketRecord(
  ...
  return {
    ...
    reflection: {
      ...
      validationEligibilityReason: "Resolution evidence is required before this Reflection can be validated.",
      evidenceIds: [],
    },
    validationRecordIds: [],
    messages: [{
      id: `ticket-message-${ticketId}-1`,
      orgId,
      ticketId,
      sequence: 1,
      direction: "customer",
      ...
      actorId: null,
      createdAt: new Date().toISOString(),
      idempotencyKey: "initial-customer-message",
    }],
    resolutionEvidence: [],
    status: "open",
