...
export const BUILT_IN_CONCEPTS: BusinessConcept[] = [
  ...
  },
  {
    ...
    aliases: [
      ...
      "registro duplicado", "registros duplicados", "entrada duplicada", "factura duplicada", "factura en doble",
      "facture en double", "facture double",
      "doppelte rechnung", "doppelte rechnungen",
      "fatura duplicada", "fatura em duplicado",
      "fattura duplicata", "fatture duplicate",
      "請求書の重複", "重複した請求書",
      "청구서 중복", "중복된 청구서",
      "发票重复", "重复发票",
