...
STOP: post-import verification is pending Batch 5.6, authority cutover is pending Batch 5.8, and mature Maesa/FastDrop/Pramana migration remains pending. The execute endpoint is unauthenticated; organization scoping is not authorization and the endpoint must not be internet-exposed without authentication.
