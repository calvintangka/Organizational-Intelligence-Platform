...
- `Graphify + initial AI-doc setup prompt lineage` — Outcome: implemented in `AGENTS.md`, `CLAUDE.md`, `.codex/hooks.json`, and the first `/ai` docs; original reusable prompt file not present.
